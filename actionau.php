		...
		<header style="text-align:center;background-color:#000116;margin-bottom: 0px;margin-top: 0px">
  		...
  		<h1 style="text-align:center;">
  			<?php
				...
				$CITY = $_POST['CITY'];
				$PS = $_POST['PS'];
				$sql = "INSERT INTO STUDENT(F_NAME, L_NAME, STREET, NUM, CITY, PS, PHONE_N) VALUES ('$F_NAME', '$L_NAME', '$STREET', '$NUM', '$CITY', '$PS', '$PHONE_N')";
		  ...
		  <h2 style="text-align: center;">
			  <p> <?php echo "Registered user: " . $F_NAME . " " . $L_NAME; ?></p>
			  <br>
			  <p> <?php echo "Telephone: " . $PHONE_N; ?></p>
		  </h2>
