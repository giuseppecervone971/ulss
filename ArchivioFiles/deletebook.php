		...
		<header style="text-align:center;background-color:#000116;margin-bottom: 0px;margin-top: 0px">
  		...
  		<h1 style="text-align:center;">
  			<?php
				...
				$ISBN = $_POST['ISBN'];
				$sql = "DELETE DISTINCT FROM COPY c LEFT JOIN RENTED_BY b on c.ISBN = b.ISBN AND c.COPY_N = b.ID_COPY AND ISBN = '$ISBN' WHERE b.ID_COPY IS NULL;";
				...
				echo "Delete Copy successfully!", PHP_EOL;
				mysqli_close($link);
			?>
  		</h1>
