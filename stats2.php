		...
		<br>
		  <h1 style="text-align:center;">
		    <?php
				...
				$sql = "SELECT e.EDITOR_ID, e.NAME, COUNT(b.ID_EDITOR) AS N_of_books_published FROM BOOK as b INNER JOIN EDITOR as e WHERE e.EDITOR_ID = b.ID_EDITOR GROUP BY b.ID_EDITOR ORDER BY N_of_books_published DESC LIMIT 1";
				...
				while($row = mysqli_fetch_array($query)) {
                    echo "The editor with most books published is: ";
					echo "<br/>";
					echo "<br/>";
					echo $row[1];
					echo "<br/>";
					echo "<br/>";
					echo "This editor has ". $row['N_of_books_published']." books published.";
				}
				mysqli_close($link);
			?>
			</h1>
