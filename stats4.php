	...
	<body style="background-color:#1A242F;color: white;">
		<header style="text-align:center;background-color:#000116;margin-bottom: 0px;margin-top: 0px">
		  ...
		  <?php
				...
				$sql = "SELECT l.NAME, COUNT(f.LIBRARY_ID) AS N_of_books_in_library FROM LIBRARY as l INNER JOIN FOUND_IN as f WHERE f.LIBRARY_ID = l.LIB_ID GROUP BY f.LIBRARY_ID ORDER BY N_of_books_in_library DESC LIMIT 1;";
				...
				while($row = mysqli_fetch_array($query)) {
                    echo "The Library with most books collected is: ";
					echo "<br/>";
					echo "<br/>";
					echo $row[0];
					echo "<br/>";
					echo "<br/>";
					echo "This Library has ". $row['N_of_books_in_library']." books collected.";
				}
				mysqli_close($link);
			?>
		  </h1>
