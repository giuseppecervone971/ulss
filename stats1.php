...
<html lang="it">
	...
	<body style="background-color:#1A242F;color: white;">
		<header style="text-align:center;background-color:#000116;margin-bottom: 0px;margin-top: 0px">
  		...
  		<br>
  		<br>
		  <h1 style="text-align:center;">COMMON 5 LANGUAGES</h1>
		  <br>
		  <br>
		  <h2>
		  <?php
				include_once('connection.php');
				$sql = "SELECT LANGUAGE,COUNT(LANGUAGE) AS N_of_times FROM BOOK GROUP BY LANGUAGE ORDER BY N_of_times DESC LIMIT 5;";
