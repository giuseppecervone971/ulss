...
<html lang="it">
	...
	<body style="background-color:#1A242F;color: white;">
		<header style="text-align:center;background-color:#000116;margin-bottom: 0px;margin-top: 0px">
			<a href="index.html"> <img src="ulss.png" alt="index.html" width="100" height="100"></a>
  		...
  		<br>
  		<br>
  		<h1 style="text-align:center;">RICERCA AVANZATA</h1>
  			<select class="select" name="Filtro 1"></select>
  			<select class="select" name="Filtro 2"></select>
  			<select class="select" name="Filtro 3"></select>
